...
export function Stamp({
  ...
  const onPointerDown = useCallback(
    (e: React.PointerEvent) => {
      ...
      const up = () => {
        setDragging(false);
        // The cursor is usually still over the stamp right after a drop —
        // reset the hover scale explicitly so it settles back to its regular
        // size at the drop spot instead of staying enlarged.
        setHovered(false);
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: `translate(${pos.x}px, ${pos.y}px) rotate(${dragging ? 0 : rotate}deg) scale(${
