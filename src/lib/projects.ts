...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Self-Serve Email Import to Drive Free Media Behaviors with Creators",
    company: "Patreon",
    blurb:
    ...
    team: "Jessica Im, Emily Slaughter",
    role: "Product Management Intern",
    tools: "Figma, Claude, Playground, VSCode, Git",
    tags: ["Product Management", "Growth"],
    cover: "/media/home/self-serve-email-imports.jpg",
    coverHtml: "/media/self-serve-email-imports/walkthrough.html",
    heroImage: "/media/self-serve-email-imports/01-arm-overview.png",
    media: [
      {
        kind: "image",
        src: "/media/self-serve-email-imports/03a-import-modal.png",
        caption: "Import layered over the list the creator is already looking at.",
        after: "Its own tab, or a modal on top of the ARM?",
      },
      {
        kind: "image",
        src: "/media/self-serve-email-imports/03b-import-tab.png",
        caption: "Import as a destination, with room for history and repeat runs.",
        after: "Its own tab, or a modal on top of the ARM?",
      },
      {
        kind: "image",
        src: "/media/self-serve-email-imports/04a-upload-with-preview.png",
      ...
      {
        kind: "image",
        src: "/media/self-serve-email-imports/04b-upload-no-preview.png",
        caption: "Lighter. The count does the reassuring instead of the rows.",
        after: "Do we show them their emails before importing?",
      },
      {
        kind: "image",
        src: "/media/self-serve-email-imports/05a-modal-step-1.png",
        caption: "Step 1: is this the right file?",
        after: "Why the modal is two steps",
      },
      {
        kind: "image",
        src: "/media/self-serve-email-imports/05b-modal-step-2.png",
        caption: "Step 2: am I ready for these people to be members?",
        after: "Why the modal is two steps",
      },
      {
        kind: "image",
        src: "/media/self-serve-email-imports/05c-modal-step-confirm.png",
        caption: "Confirm, and the import commits.",
        after: "Why the modal is two steps",
      },
      {
        kind: "image",
        src: "/media/self-serve-email-imports/06-import-in-progress.png",
        caption: "The in-progress state after the creator commits.",
        after: "Import can take up to an hour",
      },
      {
        kind: "image",
        src: "/media/self-serve-email-imports/07a-summary-results.png",
      ...
      {
        kind: "image",
        src: "/media/self-serve-email-imports/08-arm-import-filter.png",
        caption: "An import filter added to the ARM.",
        after: "And then the list disappears into the audience",
      },
      {
        kind: "context",
        src: "/media/self-serve-email-imports/walkthrough.html",
        after: "End to end",
      },
    ],
    sections: [
